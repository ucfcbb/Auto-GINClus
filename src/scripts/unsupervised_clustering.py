...
##    Feature_no = 20
    ...
    X1 = pd.read_csv(os.path.join(output_path,'Motif_candidate_embeddings.tsv'), sep = '\t')
    #X1 = pd.read_csv(os.path.join(output_path,'Motif_candidate_embeddings_AutoGINE.tsv'), sep = '\t')
    #X1 = pd.read_csv(os.path.join(output_path,'Motif_candidate_embeddings_merged2.tsv'), sep = '\t')
