...
def run_subclustering(CLUSTER_NO, unknown_motif_family_list, output_path, input_index_type, Subclus_distance_threshold):
    ...
    for clus in range(CLUSTER_NO):    
        ...
        ################################################################################
        agglo = AgglomerativeClustering(n_clusters=None, compute_full_tree=True, distance_threshold=Subclus_distance_threshold) #Used 2.5 for GIN+GAE
...
##CLUSTER_NO = 50
# CLUSTER_NO = 55
# unknown_motif_family_list = ["CL", "EL", "HT", "KT", "SR", "TS"]
# output_path = "Test1"
